...
RSpec.describe Like, type: :model do
  user = User.create(name: 'Ismail', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Programmer', posts_counter: 0)
  post = Post.create(title: 'My journey', text: 'It all started when ...', comments_counter: 0, likes_counter: 0, author: user)
